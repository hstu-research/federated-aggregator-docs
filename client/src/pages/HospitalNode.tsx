    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — ATOMIC FORMAT STAGE COMMIT</span><h2>A future format-stage run may exist only inside one fresh private sequence with a final scalar receipt.</h2></div><p>The design binds fresh candidate, current controls, new readiness, empty future resources, containment, and one exact receipt. It then either invokes the declared stage immediately or expires and removes all private state. This is design evidence only—not candidate consumption, target action, formatter execution, source transfer, container activity, runtime, Core, identity use, data/model access, trainer, submission, aggregation, release, deployment, hospital, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
