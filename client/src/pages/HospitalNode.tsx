    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — ONE-SHOT PROOF PREFLIGHT</span><h2>The future synthetic proof is now bounded to one private lifecycle, one terminal observation, and no hidden side effect.</h2></div><p>The preflight permits a future proof only after all five evidence packets are current. It defines one opaque synthetic operation, private non-public process posture, aggregation-disabled verification, one terminal observation, mandatory cleanup, and an aggregate-safe record. Expiry, mismatch, duplicate admission, pre-route cancellation, interruption, failure, residue, or cleanup uncertainty closes with no retry, target substitution, fallback identity, public listener, trainer, submission, or aggregation. No package/credential use, target binding, Agent start, proof, training, submission, or aggregation action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
