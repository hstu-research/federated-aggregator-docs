    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SOURCE-ONLY EVIDENCE-BUNDLE FREEZER QUALITY-GATED</span><h2>A projected partial readout can be frozen once without retention, publication, or operational authorization.</h2></div><p>Agent release <strong>d57facd</strong> adds a scalar evidence-bundle freezer that validates exact projected-partial classes, preserved terminal Python closure, no-retry posture, identity, and capability limits before freezing one non-retained result. Local CI and Hospital Node Quality Gates passed with deterministic source-only fixtures. This is source-quality evidence only—not retained storage, a public record, Python-test pass, target full-CI certification, release, deployment, runtime, hospital, Core, identity, data/model, training, submission, aggregation, or scientific evidence. No target action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
