    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SYNTHETIC STUDY-INTENT CONSUMPTION DESIGNED</span><h2>A frozen proposed-study declaration can be consumed once without starting or evaluating a study.</h2></div><p>The next design accepts only an exact frozen proposed-study validator receipt/readout, preserved non-execution posture, no-retry state, unused identity, and no study/target/runtime capability. It can emit only an allowlisted consumed scalar or closure. This is design evidence only—not a study, test, training, data/model access, metric, update, submission, aggregation, score, empirical result, hospital, clinical, privacy, runtime, or scientific claim.</p><CheckCircle2 size={24} /></section>
        </div>
