    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>INJECTED PARSER POLICY SOURCE QUALITY</span><h2>One inert abstract shape is quality-gated through discard; promotion remains disabled.</h2></div><p>Release <code>05a87a3</code> implements the source-only injected renderer policy, private parser fake, private blueprint/workspace ports, frozen readout, and import guard. One inert shape may take symbolic temporary → validation → discard and return <code>not_rendered_after_discard</code>; promotion has no callable operation. Malformed, fallback, workspace, blueprint, every parser class, temporary, validation, cleanup, and replay cases close terminally. Local CI and Hospital Node Quality Gates passed. No renderer execution, configuration text/file, filesystem, target action, package/credential access, staging, proof, training, submission, or aggregation action occurred. Concrete abstract-shape validation remains separately gated.</p><CheckCircle2 size={24} /></section>
        </div>
