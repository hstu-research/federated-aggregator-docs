    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>NEXT LOCAL IMPLEMENTATION GATE</span><h2>Implement concrete adapters under local negative tests before any Agent may make a request.</h2></div><p>The L4c review artifacts now prove configuration redaction, two-route allowlisting, safe response classification, private-root criteria, and pathless cleanup obligations without constructing an adapter. Next, L4d may implement the concrete transport and private workspace under local-only tests and safe observability. No deployment, Core/Azure request, training, update, submission, provider contact, or aggregation-worker activation is permitted.</p><CheckCircle2 size={24} /></section>
        </div>
