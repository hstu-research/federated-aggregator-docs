...
const documents = [
  ...
  { title: "Final source-only thesis review package", description: "Compact archive of the editable manuscript and claim-control materials for supervisor, examiner, or copy-edit review.", file: "SYNTHETIC_FEDPROX_THESIS_FINAL_REVIEW_PACKAGE.zip", href: "/manus-storage/SYNTHETIC_FEDPROX_THESIS_FINAL_REVIEW_PACKAGE_e2e03b64.zip" },
    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — FINAL REVIEW PACKAGE RETAINS THE BOUNDED CONTRIBUTION</span><h2>The thesis materials are bundled for review without evidence expansion.</h2></div><p>The final review package groups the editable manuscript with the authoritative manuscript, executive brief, and claim-control materials. It supports editorial review only and retains the source-only research question, method, local findings, explicit non-results, and independently governed future-work path. No data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
