    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>NEXT TRANSPORT DESIGN GATE</span><h2>Specify the typed Core client before an Agent may leave its local test boundary.</h2></div><p>The Agent now verifies generated in-memory bytes against one persisted receipt, proves promotion/cleanup/abort behavior, and returns only scalar evidence. The next step is a fresh contract for the typed hospital-node Core client and private workspace adapter. It must remain before any OIDC token, Core HTTP request, Azure Agent execution, filesystem path, Python training, update, submission, provider contact, or aggregation-worker activation.</p><CheckCircle2 size={24} /></section>
        </div>
