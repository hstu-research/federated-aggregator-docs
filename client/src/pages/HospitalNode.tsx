    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>NEXT PROTECTED RELEASE GATE</span><h2>Verify every source and runtime safety condition before a one-shot profile can create its handoff.</h2></div><p>Core and Agent now validate the narrow private handoff/result contracts and prove lease-first coordination through injected local fakes. Next, Agent/Core quality and release conclusions, target Compose rendering, Core health, disabled worker, runner absence, and safe initial proof state must be recorded. No target profile, Core/Azure request, training, update, submission, provider contact, or aggregation-worker activation is permitted until each gate is green.</p><CheckCircle2 size={24} /></section>
        </div>
