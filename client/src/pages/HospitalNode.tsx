    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SOURCE-ONLY EVIDENCE READER QUALITY-GATED</span><h2>Stage-level evidence is preserved as partial context, never promoted to a whole-CI pass.</h2></div><p>Agent release <strong>4518773</strong> adds a frozen scalar evidence reader that validates stage and cleanup classes, preserves the terminal Python closure, and suppresses replay. Local CI and Hospital Node Quality Gates passed with deterministic source-only fixtures. This is source-quality evidence only—not a Python-test pass, target full-CI certification, release, deployment, runtime, hospital, Core, identity, data/model, training, submission, aggregation, or scientific evidence. No target action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
