    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — READ-ONLY REMOTE QUALITY OBSERVATION DESIGNED</span><h2>Remote quality state may be observed once without dispatching, retrying, or changing a workflow.</h2></div><p>The next design reduces one release-scoped remote state to an allowlisted observed-pass, observed-fail, unobserved, or closure class. It retains no workflow identifier, commit, log, annotation, provider fact, or free text and cannot dispatch, retry, cancel, configure, approve, merge, publish, or modify a remote workflow. This is design evidence only—not source-quality certification, a study, target permission, deployment eligibility, runtime proof, hospital, clinical, privacy, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
