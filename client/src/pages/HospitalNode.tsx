    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SYNTHETIC FEDPROX STUDY-INTENT CONTRACT DESIGNED</span><h2>A proposed study is explicit before any trainer, data, model, metric, update, or aggregation action.</h2></div><p>The new design binds only a scalar proposed-study classification with trainer-not-started, data/model-not-accessed, metric-absent, update-not-created, submission-not-started, aggregation-disabled, and no-runtime/target-capability states. It can emit only an admitted proposal or closure. This is design evidence only—not a study, test, training, data/model access, metric, update, submission, aggregation, runtime, hospital, clinical, privacy, or scientific result.</p><CheckCircle2 size={24} /></section>
        </div>
