    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SUBMISSION READINESS IS LIMITED TO THE SOURCE-ONLY CONTRIBUTION</span><h2>The thesis can be accurate without inventing an empirical result.</h2></div><p>The new audit maps completed source-only documentation and local contract evidence to claim-safe thesis sections, while marking empirical, data/model, privacy, clinical, hospital, operational, and deployment evidence as absent. No contact, approval, data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
