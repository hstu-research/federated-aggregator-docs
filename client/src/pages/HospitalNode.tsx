    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SOURCE-ONLY PUBLICATION PROJECTOR QUALITY-GATED</span><h2>A partial readout can become one safe scalar without writing publicly or authorizing operations.</h2></div><p>Agent release <strong>cba8b2e</strong> adds a scalar projector that validates exact consumed-partial reader classes, preserved terminal Python closure, no-retry posture, identity, and capability limits before projecting one allowlisted result. Local CI and Hospital Node Quality Gates passed with deterministic source-only fixtures. This is source-quality evidence only—not a public write, Python-test pass, target full-CI certification, release, deployment, runtime, hospital, Core, identity, data/model, training, submission, aggregation, or scientific evidence. No target action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
