    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — TARGET QUALITY RETRIES EXHAUSTED</span><h2>The final isolated diagnostic classifies a non-zero quality exit and stops further target retries.</h2></div><p>The third fresh source/workspace/image/container instance emitted only <code>quality_exit_nonzero</code>; no failing command, test, file, package, source, path, environment, configuration, credential, or transcript was retained. No named container or disposable image remains, and the workspace is non-running. Further target diagnostic/build retries require new guidance; no pass, runtime, Core, data/model, trainer, submission, aggregation, release, deployment, hospital, or scientific claim occurred.</p><CheckCircle2 size={24} /></section>
        </div>
