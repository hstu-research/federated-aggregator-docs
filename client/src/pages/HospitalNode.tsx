    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>SYNTHETIC SCALAR VALIDATOR SOURCE QUALITY</span><h2>One immutable inert shape is quality-gated without a parser, workspace, or renderer.</h2></div><p>Release <code>1408470</code> implements the source-only scalar validator, private canonical inert marker, immutable request normalization, frozen readout, replay suppression, fixtures, and import guard. One canonical synthetic object yields <code>inert_shape_validated</code>; malformed, unknown, missing, inherited, mutable, duplicate, control, binding/image, command/promotion, and replay cases close terminally. Local CI and Hospital Node Quality Gates passed. No text parser, renderer, configuration text/file, filesystem, target action, package/credential access, staging, proof, training, submission, or aggregation action occurred. Validator-to-renderer-policy injection remains separately gated.</p><CheckCircle2 size={24} /></section>
        </div>
