    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — PACKAGE-MANAGER COLLECTOR BOUNDARY CLOSED</span><h2>The closure diagnostic isolated package-manager accessibility in the hardened collector context.</h2></div><p>A fresh source/workspace/image/container diagnostic emitted only <code>receipt_package_manager_closed</code>: the declared package-manager surface was unavailable to the unprivileged, read-only collector context. No version, executable location, cache, command, output, path, configuration, credential, source, package, provider, target, model, data, or transcript was retained. No named container or disposable image remains and the workspace is non-running; no composition, quality, release, deployment, runtime, hospital, Core, identity, data/model, trainer, submission, aggregation, or scientific claim occurred.</p><CheckCircle2 size={24} /></section>
        </div>
