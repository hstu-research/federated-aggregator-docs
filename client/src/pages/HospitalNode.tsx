    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — TERMINAL READINESS PROJECTS A DISABLED FAKE OUTCOME</span><h2>A terminal record cannot construct an evaluation workflow.</h2></div><p>The deterministic in-memory fake accepts only the frozen all-gates-unassigned terminal record and projects one disabled scalar outcome. Unsafe or replayed input also closes without an action path. It is not storage, transport, or a deployment component and cannot issue authority, approval, or a study path. Every independent readiness gate remains unsatisfied; no data/model, training, metric, aggregation, remote, target, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
