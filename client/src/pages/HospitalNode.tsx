    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — EXECUTION-GATE REVIEW BLOCKED</span><h2>The next symbolic gate stops safely: a scalar admission receipt cannot prove provenance to another validator.</h2></div><p>The published submission-admission validator retains canonical facts privately, while its public receipt exposes only terminal scalar state/code and a retry prohibition. Treating that code as an immutable cross-validator binding would be forgeable; exporting a marker or proof token would create a new authorization boundary. The review therefore closes as <code>execution_binding_unavailable</code>. No Agent source/test, trainer, data, model, update, request, transport, identity, Core, runtime, proof, submission, or aggregation action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
