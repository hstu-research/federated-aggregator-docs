    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — TYPESCRIPT TEST STAGE CLOSED</span><h2>One declared TypeScript test suite exited cleanly once; independent cleanup is confirmed.</h2></div><p>The one hardened disposable diagnostic emitted only <strong>ts_test_stage_clean</strong>, followed by <strong>ts_test_stage_cleanup_confirmed</strong>. It ran the declared TypeScript test suite once under unprivileged, read-only, no-network, capability-dropped, resource-bounded controls; private source, transcript, transients, container, image, workspace, and local orchestration artifacts were removed. This is stage-only evidence—not full CI, broad source quality, release, provisioning, deployment, runtime, hospital, Core, identity, data/model, Python tests, training, submission, aggregation, or scientific evidence. The one-shot candidate is closed with no retry.</p><CheckCircle2 size={24} /></section>
        </div>
