    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SYNTHETIC STUDY-INTENT CONSUMER LOCAL EVIDENCE ONLY</span><h2>A proposed study can be consumed once without starting or evaluating a study; remote quality evidence remains unobserved.</h2></div><p>Agent release <strong>d6f121c</strong> adds a scalar consumer that validates exact proposed-study/non-execution/no-retry states before projecting one allowlisted result. Local CI passed with deterministic source-only fixtures. A matching remote Hospital Node Quality Gates run was not observed during the bounded window, so no remote-gate pass is claimed. This remains local source-quality evidence only—not a study, test, training, data/model access, metric, update, submission, aggregation, target full-CI certification, release, deployment, runtime, hospital, clinical, privacy, or scientific result.</p><CheckCircle2 size={24} /></section>
        </div>
