    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>PRE-ROUTE BLOCK</span><h2>Compose the private Agent proof topology before a one-shot profile can create its handoff.</h2></div><p>Agent and Core source gates are green; Core is live/ready and its aggregation worker remains disabled. The target has no Agent proof composition, directional private channels, Agent image source, or runtime profile, so the proof is blocked before fixture creation, token acquisition, lease, intent, stream, or workspace write. Next, implement and release the documented private topology; no training, update, submission, provider contact, or aggregation-worker activation is permitted.</p><CheckCircle2 size={24} /></section>
        </div>
