    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — PRE-EMPIRICAL READINESS IS DEFAULT-CLOSED</span><h2>A study proposal cannot become an experiment by assumption.</h2></div><p>The new readiness protocol records the independent authority, governance, data stewardship, protocol, evaluation, reproducibility, monitoring, and reporting gates that would be required before an empirical study could even be considered. Every gate remains unassigned and unsatisfied. No approval, data/model, training, metric, aggregation, remote, target, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
