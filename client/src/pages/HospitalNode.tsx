    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>SOURCE-ONLY CONTROL — ONE-USE REJECTION RECEIPT CONSUMPTION PRESERVES CLOSURE</span><h2>A generated rejection receipt can be consumed once without reopening any transfer state.</h2></div><p>The isolated Agent consumer accepts only an exact frozen scalar local-rejection receipt, returns a blocked, evaluation-not-started, execution-not-performed readout, denies altered inputs, and suppresses replay. Its aggregate local quality suite passed. It receives no payload, does not ingest or process patient data, and is not privacy, clinical, hospital, deployment, or runtime proof.</p><CheckCircle2 size={24} /></section>
        </div>
