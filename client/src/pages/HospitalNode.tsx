    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — MANUSCRIPT ASSEMBLY IS CLAIM-SAFE</span><h2>Every chapter now has a bounded purpose and a visible evidence limit.</h2></div><p>The new assembly map organizes the completed thesis artifacts from abstract through conclusion, assigns each a narrow citation role, and requires recurring absence statements across results and future work. No data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
