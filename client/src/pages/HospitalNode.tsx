    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — EDITABLE MANUSCRIPT RETAINS THE BOUNDED CONTRIBUTION</span><h2>The editable draft is ready for institutional formatting without evidence expansion.</h2></div><p>The new Word companion carries the integrated manuscript with editorial placeholders and an editable contents field. It retains the source-only research question, method, local findings, explicit non-results, and independently governed future-work path. No data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
