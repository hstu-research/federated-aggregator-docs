    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — PARTIAL READOUT CONSUMPTION DESIGNED</span><h2>A frozen partial readout may be consumed once without exposing evidence internals.</h2></div><p>The next design accepts only the reader’s exact frozen partial receipt/readout, preserved terminal Python closure, no-retry posture, unused identity, and no target/runtime capability. It can emit only an allowlisted consumed or closed scalar result—never a stage detail, score, pass, certification, release, deployment, runtime, hospital, Core, identity, data/model, training, submission, aggregation, or scientific claim. This is design evidence only; no source or target activity occurred.</p><CheckCircle2 size={24} /></section>
        </div>
