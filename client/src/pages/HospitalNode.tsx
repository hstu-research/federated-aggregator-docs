    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SOURCE VERIFIED, RELEASE BINDING ABSENT</span><h2>The quality-gated Agent revision is clean and exact, but it is not a target-bound release.</h2></div><p>The reviewed source revision has a matching clean local state and successful recorded Quality Gates evidence. That establishes only <code>source_quality_verified_release_binding_absent</code>: no target-specific release identity exists, so no source/seed transfer, target configuration action, installation, build, service, Agent/container, Core/runtime, proof, data/model/trainer, submission, or aggregation action is authorized or occurred.</p><CheckCircle2 size={24} /></section>
        </div>
