    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>CONCRETE ABSTRACT-SHAPE VALIDATOR REVIEW</span><h2>A future local validator can normalize one inert scalar shape without ever parsing text.</h2></div><p>The injected parser policy remains quality-gated at <code>05a87a3</code>. The new review defines exact scalar activation, exposure, restart, network, binding, image, workload, and promotion classes; only one frozen canonical state maps to <code>inert_shape</code>. Mutable, unknown, missing, duplicate-detected, active, exposed, restart, host-network, binding, image, command, promotion, and replay classes close terminally. A future text parser, if separately designed, must project duplicate syntax as a scalar denial. No text parser, renderer, configuration text/file, filesystem, target action, package/credential access, staging, proof, training, submission, or aggregation action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
