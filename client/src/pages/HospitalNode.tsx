    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>NEXT ADAPTER-REVIEW GATE</span><h2>Specify concrete transport and private-workspace safeguards before an Agent may leave its fake boundary.</h2></div><p>The deterministic fakes now prove the typed intent/stream contract, denial classes, generated-byte projection, and pathless workspace cleanup without a socket or filesystem. Next, L4c must document configuration ownership, token seam, response validation, error map, private-root permissions, and cleanup failure handling. No Core request, Azure Agent execution, training, update, submission, provider contact, or aggregation-worker activation is permitted.</p><CheckCircle2 size={24} /></section>
        </div>
