    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — RELEASE AUTHORITY PROTOCOL UNASSIGNED</span><h2>A redacted authority decision path exists, but no authority, exception, or release decision is active.</h2></div><p>The protocol separates the future risk/release owner from source, provision, runtime, Agent, Core, and human/browser/ML-worker execution identities; it accepts only scalar packet classes, a one-use expiry-bounded purpose, and append-only decision/revocation closure. The current state is <code>unassigned</code>: no authority, exception, release, target contact, transfer, installation, build, runtime, proof, data/model/trainer, submission, or aggregation action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
