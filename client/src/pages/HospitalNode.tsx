    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>SYNTHETIC INJECTION SOURCE QUALITY</span><h2>Private-root synthetic injection is quality-gated with nonenumerability fixtures; target controls remain blocked.</h2></div><p>The fresh immutable candidate completed real build/publish with BuildKit OCI provenance requested, while the earlier unavailable-attestation candidate remains closed. Release <code>19340fc</code> implements the pure injection validator, private-field synthetic marker, deterministic construction fake, and redaction fixtures. Fixed non-path sentinels cannot enter serialization, inspection, enumeration, errors, snapshots, or decisions. One eligible ready-not-activated request may hand off to a fake; malformed/noneligible/fallback/invalid-sentinel/construction-failure/replay cases close terminally. Local CI and Hospital Node Quality Gates succeeded. No raw root/parser/filesystem/deployment/mount/image/package/target/credential/proof/training/submission/aggregation action occurred. Static target-composition rendering is a separate future design boundary.</p><CheckCircle2 size={24} /></section>
        </div>
