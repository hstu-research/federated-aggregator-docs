    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — VERIFIED FRONT MATTER RETAINS THE BOUNDED CONTRIBUTION</span><h2>The thesis now applies corroborated conventions while leaving unknown fields blank.</h2></div><p>The updated Word manuscript applies only the course, degree, department, location, title-page, and certificate-role conventions corroborated in supplied materials. Candidate, student ID, supervisor, signature, date, and approval fields remain blank when not verified for this manuscript, while the source-only research question, method, local findings, explicit non-results, and independently governed future-work path are retained. No data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
