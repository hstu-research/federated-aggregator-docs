    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — EVIDENCE MATRIX PUBLISHED</span><h2>Proposed FedProx intent is not an empirical result.</h2></div><p>The thesis evidence matrix now distinguishes the documented research question and source-only controls from any executed experiment. It permits careful methodology and limitation language while excluding data/model use, training, metrics, updates, aggregation, clinical impact, or performance claims. No remote, target, study, runtime, or clinical activity is authorized or evidenced.</p><CheckCircle2 size={24} /></section>
        </div>
