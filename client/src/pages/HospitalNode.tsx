    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — ATOMIC TYPE-CHECK COMMIT</span><h2>A future type check may exist only inside one fresh private sequence with a final scalar receipt.</h2></div><p>The design binds fresh candidate, current source/type-check controls, new readiness, image-local manager, empty future resources, containment, and one exact receipt. It then either invokes the declared type check immediately or expires and removes all private state. This is design evidence only—not candidate consumption, target action, type-check execution, source transfer, container activity, runtime, Core, identity, data/model, trainer, submission, aggregation, release, deployment, hospital, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
