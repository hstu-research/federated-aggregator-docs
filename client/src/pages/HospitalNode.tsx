    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SOURCE-ONLY REMOTE QUALITY CLASSIFIER VALIDATED</span><h2>A frozen scalar state can be classified locally without querying or changing a workflow.</h2></div><p>The classifier accepts only an exact frozen observed-pass, observed-fail, or unobserved declaration and emits one scalar receipt with remote observation not attempted and execution not performed. Deterministic fixtures, replay closure, and import isolation are locally validated. It did not query, dispatch, retry, cancel, configure, or modify any workflow; it is not a remote quality result, source-quality certification, study authority, target permission, deployment eligibility, runtime proof, hospital, clinical, privacy, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
