    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — FRESH DIAGNOSTIC IDENTITY CONTROL</span><h2>Any future target format check must obtain a fresh, expiring, one-use identity after revalidation.</h2></div><p>The design requires a new opaque harness identity, fresh scalar predicates, a private expiry class, one retry-disabled receipt, and terminal removal on closure. Identity and timing details cannot leave the harness. This is design evidence only—not target revalidation, formatter execution, source transfer, container activity, runtime, Core, identity use, data/model access, trainer, submission, aggregation, release, deployment, hospital, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
