    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — DEFENSE NARRATIVE REMAINS CLAIM-SAFE</span><h2>The oral defense can explain the contribution without presenting a study result.</h2></div><p>The new defense brief supplies a bounded narrative, anticipated questions, grounded answers, and phrases to avoid. It keeps local source-only evidence separate from absent empirical, privacy, clinical, hospital, operational, deployment, and runtime evidence. No data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
