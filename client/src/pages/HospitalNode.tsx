    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — FINAL FORMAT START GATE</span><h2>No admitted candidate can start until its private receipt and empty future resources are checked again.</h2></div><p>The design consumes only current private authorization and revalidation classes, then reads future container, image, workspace, and not-started posture. Any expiry, drift, cleanup failure, or replay removes private state before a diagnostic resource can exist. This is design evidence only—not target action, formatter execution, source transfer, container activity, runtime, Core, identity use, data/model access, trainer, submission, aggregation, release, deployment, hospital, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
