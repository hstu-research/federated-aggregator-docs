    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — COMPOSITION RECEIPT CLOSED</span><h2>The redacted local-to-target composition check closed before a comparison state.</h2></div><p>The local receipt was sealed and a fresh isolated target image built, but its single receipt invocation ended as <code>receipt_closed</code> before a match/difference state. No dimension-level fact, raw count, digest, filename, path, source, package, provider, target, configuration, credential, model, data, or transcript was retained. No named container or disposable image remains, the workspace is non-running, and local receipt artifacts were removed; no runtime, Core, data/model, trainer, submission, aggregation, pass, release, deployment, hospital, or scientific claim occurred.</p><CheckCircle2 size={24} /></section>
        </div>
