    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — CLAIM CONSISTENCY HAS BEEN AUDITED</span><h2>Every thesis artifact retains the same evidence boundary.</h2></div><p>The new consistency audit reviews the abstract, methods, evidence matrix, results, conclusion, manuscript map, readiness audit, and defense brief against the source-only boundary. Empirical, privacy, clinical, hospital, operational, deployment, and runtime evidence remains absent throughout. No data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
