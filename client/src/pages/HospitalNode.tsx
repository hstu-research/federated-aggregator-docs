    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>NEXT PRIVATE-COORDINATION GATE</span><h2>Prove one ephemeral handoff locally before any protected profile may create a generated fixture.</h2></div><p>The protected preflight profile now validates opaque reference classes, and the private handoff contract removes any need for assignment discovery. Next, deterministic Core/Agent coordination components may prove one handoff, lease-first binding, scalar result, and cleanup through private fakes only. No target-runtime profile, Core/Azure request, training, update, submission, provider contact, or aggregation-worker activation is permitted.</p><CheckCircle2 size={24} /></section>
        </div>
