    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — DEFAULT-CLOSED READINESS RECEIPT CONSUMED LOCALLY</span><h2>An ineligible readiness receipt stays ineligible after one use.</h2></div><p>The source-only consumer accepts only the frozen all-gates-unassigned receipt, emits one scalar closure preserving evaluation not started and execution not performed, rejects broadened or unsafe input, and suppresses replay. It has no persistence and cannot issue authority, approval, or a study path. Every independent readiness gate remains unsatisfied; no data/model, training, metric, aggregation, remote, target, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
