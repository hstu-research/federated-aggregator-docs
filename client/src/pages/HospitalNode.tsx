    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — CONCRETE EXTERNAL ADAPTERS REMAIN INELIGIBLE</span><h2>A disabled in-memory fake is not permission to connect anything.</h2></div><p>The new eligibility review keeps every storage, transport, provider, governance, identity, and runtime adapter closed by default. Independent authority, scope, redaction, non-mutating posture, lifecycle controls, and proof preconditions are all unassigned. No adapter code, configuration, connection, credential, request, data/model, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
