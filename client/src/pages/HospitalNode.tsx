    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — GOVERNANCE HANDOFF CLOSES THIS SOURCE-ONLY BRANCH</span><h2>Nothing empirical starts until independent decisions exist.</h2></div><p>The new handoff brief consolidates the authority, governance, data stewardship, protocol, evaluation, safety, reporting, and adapter-review decisions needed before an empirical study could be considered. Every item remains unassigned, and no contact, approval, data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
