    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — HARDENED ONE-SHOT FORMAT STAGE</span><h2>The future target format check is specified as one disposable stage with scalar parsing and mandatory cleanup.</h2></div><p>The plan binds current scalar prerequisites and permits only the declared format stage in a disposable unprivileged read-only no-network container. It parses one scalar outcome, removes private source/transcript/transients/container/image, and stops. A clean stage result is not full CI or runtime evidence. This is design evidence only—not target action, formatter execution, source transfer, container activity, runtime, Core, identity use, data/model access, trainer, submission, aggregation, release, deployment, hospital, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
