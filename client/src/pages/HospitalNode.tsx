    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — FORMAT EXECUTION READINESS</span><h2>The hardened format-stage posture is scalar-ready; the diagnostic remains uninvoked.</h2></div><p>One isolated read-only review emitted <code>format_execution_ready</code> for the published source/control and candidate target posture classes. No candidate was consumed and no host or Docker resource changed. The readiness expires and does not authorize a formatter, source transfer, image/container activity, workspace, runtime, Core, identity, trainer, submission, aggregation, release, deployment, hospital, or scientific claim.</p><CheckCircle2 size={24} /></section>
        </div>
