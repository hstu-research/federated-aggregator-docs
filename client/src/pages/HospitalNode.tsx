    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SOURCE-ONLY READOUT CONSUMER QUALITY-GATED</span><h2>A frozen partial readout can be consumed once without becoming an operational authorization.</h2></div><p>Agent release <strong>93eb5b3</strong> adds a scalar readout consumer that validates exact reader receipt/readout classes, preserved terminal Python closure, no-retry posture, identity, and capability limits before projecting one allowlisted result. Local CI and Hospital Node Quality Gates passed with deterministic source-only fixtures. This is source-quality evidence only—not a Python-test pass, target full-CI certification, release, deployment, runtime, hospital, Core, identity, data/model, training, submission, aggregation, or scientific evidence. No target action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
