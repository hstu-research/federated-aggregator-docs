    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — PROTECTED PREFLIGHT REVIEW</span><h2>The remaining runtime path is now explicit: five independent evidence packets, one closed gate, and no hidden shortcut.</h2></div><p>The review reduces deployment readiness to five separately valid, current, and redacted packet classes: source quality, protected package/identity authorization, target-bound release, protected composition/configuration, and immediate Core-control evidence. Any malformed, mismatched, broadened, stale, revoked, duplicate, or unsafe packet closes without target contact, process start, credential retry, fallback identity, or a public listener. No package access, target binding, Agent start, proof, training, submission, or aggregation action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
