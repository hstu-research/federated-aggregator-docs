    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — DEFAULT REMOTE-OBSERVATION INELIGIBILITY VALIDATED LOCALLY</span><h2>The current unassigned posture closes before any workflow access can begin.</h2></div><p>The source-only validator accepts only the frozen default-closure declaration, emits one ineligible receipt, rejects broadened authority claims, and suppresses replay. It makes no remote call and cannot issue permission. Separately assigned authority, bounded scope, fixed redaction, and non-mutating controls remain prerequisites for any future consideration; no remote, target, study, runtime, or clinical activity is authorized or evidenced.</p><CheckCircle2 size={24} /></section>
        </div>
