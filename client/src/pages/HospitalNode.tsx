    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>SOURCE-ONLY CONTROL — DISABLED APPLICATION FAKE PROJECTS ONLY TERMINAL CLOSURE</span><h2>A synthetic rejection outcome cannot become an enabled application action.</h2></div><p>The isolated Agent test double accepts only one exact frozen terminal record and returns a blocked, evaluation-not-started, execution-not-performed disabled outcome. It denies altered inputs and suppresses replay; its aggregate local quality suite passed. It receives no payload, does not process patient data, and is not an upload, privacy, clinical, hospital, deployment, or runtime proof.</p><CheckCircle2 size={24} /></section>
        </div>
