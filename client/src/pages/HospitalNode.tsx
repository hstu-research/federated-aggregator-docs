    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — EXACT PACKAGE ACQUISITION DESIGNED</span><h2>The missing pnpm class now has one official, integrity-gated local acquisition design—without a download.</h2></div><p>The boundary selects only <code>pnpm@10.16.1</code>, one official provenance class, and one internally verified integrity class. It rejects mutable selectors, alternate mirrors, redirects, cache fallback, target-side installers, and script execution; its finite lifecycle closes before any substitution or runtime broadening. No package resolution/download/activation/verification, seed creation, target transfer/change, source build, container/Agent start, Core contact, proof, data/model/trainer, submission, or aggregation action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
