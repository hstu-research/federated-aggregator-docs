    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SOURCE-ONLY NORMALIZATION ADMISSION</span><h2>The scalar formatting-normalization admission policy is quality-gated without invoking a formatter.</h2></div><p>Agent release <code>6f62662</code> admits only exact frozen reviewed-revision, composition-context, image-local-manager, fixed-profile, no-runtime, unused-identity, and cleanup-confirmable classes through a deterministic scalar fake. Local CI and protected quality gates passed. This is source-quality evidence only—not formatting execution, target access, image/container build, release, deployment, runtime, hospital, Core, identity, data/model, trainer, submission, aggregation, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
