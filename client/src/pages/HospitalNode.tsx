    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — PYTHON TEST BOUNDARY DESIGNED</span><h2>A future Python test suite is constrained to one isolated scalar-safe diagnostic.</h2></div><p>The next design permits only the declared Python test suite under a new private candidate, image-local Python test surface, resource absence, hardened containment, scalar-only outcome map, mandatory cleanup, and terminal no-retry closure. It cannot reuse closed quality candidates or run TypeScript tests, formatting, type checks, import guards, source repair, runtime, Core, identity, data/model, training, submission, aggregation, release, deployment, hospital, or scientific paths. This is design evidence only; no Python test or target activity occurred.</p><CheckCircle2 size={24} /></section>
        </div>
