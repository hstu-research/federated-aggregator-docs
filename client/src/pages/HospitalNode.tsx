    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>NEXT DEPLOYMENT-PROOF DOSSIER</span><h2>Define the one-shot runtime gate before these local adapters may touch a real boundary.</h2></div><p>The Agent now has injected concrete transport and workspace logic under generated test doubles, with scalar-safe outcomes and compensation behavior. Next, L4e must document production wiring, release gates, redacted preflight and closure criteria, and one opt-in synthetic proof. No deployment, Core/Azure request, training, update, submission, provider contact, or aggregation-worker activation is permitted until that dossier is published and validated.</p><CheckCircle2 size={24} /></section>
        </div>
