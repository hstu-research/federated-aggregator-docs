    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — PARTIAL READOUT PUBLICATION PROJECTION DESIGNED</span><h2>A consumed partial readout can be reduced to one publication-safe scalar without exposing evidence internals.</h2></div><p>The next design accepts only an exact frozen consumed-partial receipt/readout, preserved terminal Python closure, no-retry posture, unused identity, and no target/runtime/publication capability. It can emit only an allowlisted projection or closure—never a stage detail, public write, score, pass, certification, release, deployment, runtime, hospital, Core, identity, data/model, training, submission, aggregation, or scientific claim. This is design evidence only; no source or target activity occurred.</p><CheckCircle2 size={24} /></section>
        </div>
