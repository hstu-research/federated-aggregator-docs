    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — REMEDIATED COMPOSITION RECEIPTS MATCH</span><h2>The fresh hardened comparison matched its designated scalar composition categories.</h2></div><p>A sealed local receipt and fresh image-local package-manager collector emitted <code>composition_matches</code> after repository-relative digest normalization. No raw receipt value, count, digest, filename, path, source, package, provider, registry, target, configuration, credential, model, data, or transcript was retained. No named container or disposable image remains and the workspace is non-running; this is composition context only—not formatting, source quality, provisioning, release, deployment, runtime, hospital, Core, identity, data/model, trainer, submission, aggregation, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
