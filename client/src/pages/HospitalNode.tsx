    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — FRESH CANDIDATE EXPIRED</span><h2>The fresh format-stage candidate was scalar-ready, then expired unconsumed as required.</h2></div><p>One fresh private candidate emitted <code>format_fresh_candidate_ready</code> from a read-only posture review, then immediately expired and was removed with its private review state. No host or Docker resource changed. This does not authorize a format stage, source transfer, image/container activity, workspace, runtime, Core, identity, trainer, submission, aggregation, release, deployment, hospital, or scientific claim.</p><CheckCircle2 size={24} /></section>
        </div>
