    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — FINAL EDITORIAL HANDOFF RETAINS THE BOUNDED CONTRIBUTION</span><h2>The full draft is ready for editorial review without evidence expansion.</h2></div><p>The new final editorial handoff permits clarity, organization, citation, and institution-format review of the integrated manuscript while retaining its explicit non-results. Any request for empirical, privacy, clinical, hospital, operational, deployment, or runtime claims remains outside this branch and requires independent governance. No data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
