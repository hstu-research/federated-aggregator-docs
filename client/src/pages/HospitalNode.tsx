    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>NEXT NON-RUNTIME REVIEW GATE</span><h2>Exercise configuration and lifecycle criteria without instantiating a transport or filesystem.</h2></div><p>The L4c review now fixes configuration ownership, fixed guarded routes, token containment, response validation, private-root lifecycle, and cleanup-failure posture before code. Next, type-only L4c1/L4c2 artifacts may prove those criteria with fakes. No environment read, token, socket, filesystem action, Core/Azure request, training, update, submission, provider contact, or aggregation-worker activation is permitted.</p><CheckCircle2 size={24} /></section>
        </div>
