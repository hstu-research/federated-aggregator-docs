    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — REGISTRY INTEGRITY VERIFIED, PROVENANCE UNAVAILABLE</span><h2>The sealed exact pnpm seed matches registry integrity, but missing provenance still blocks target use.</h2></div><p>A read-only review matched the sealed candidate to the exact registry-integrity class for <code>pnpm@10.16.1</code>. No provenance or attestation metadata was available, so <code>local_seed_registry_integrity_verified_provenance_unavailable</code> remains target-blocked: no transfer, install, activation, source build, container/Agent, Core/runtime, proof, data/model/trainer, submission, or aggregation action is permitted.</p><CheckCircle2 size={24} /></section>
        </div>
