    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — RESULTS AND DISCUSSION REMAIN CLAIM-SAFE</span><h2>Bounded source-only findings are not an empirical FedProx result.</h2></div><p>The new draft reports frozen study intent, terminal closure, default-closed readiness, and disabled application projection while explicitly labeling data/model, training, metric, privacy, clinical, hospital, operational, deployment, and runtime evidence as absent. No data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
