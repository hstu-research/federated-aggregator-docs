    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — PROVENANCE EXCEPTION DECISION NOT RECORDABLE</span><h2>The exception record is specified, but missing authority and current evidence prevent any decision.</h2></div><p>The scalar matrix requires seed integrity/provenance, source/release, composition, Core control, authority/reviewer separation, compensating controls, decision, expiry, and revocation classes. Current state is <code>provenance_exception_decision_not_recordable</code>: provenance is unavailable, authority unassigned, composition closed, Core control absent, and release identity inactive. No exception, release, target contact, transfer, installation, build, runtime, proof, data/model/trainer, submission, or aggregation action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
