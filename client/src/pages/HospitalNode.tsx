    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — DEFAULT-CLOSED EMPIRICAL READINESS VALIDATED LOCALLY</span><h2>An unassigned readiness state closes before evaluation can begin.</h2></div><p>The source-only validator accepts only the frozen all-gates-unassigned declaration, emits one ineligible receipt, rejects broadened or unsafe input, and suppresses replay. It cannot issue authority, approval, or a study path. Every independent readiness gate remains unsatisfied; no data/model, training, metric, aggregation, remote, target, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
