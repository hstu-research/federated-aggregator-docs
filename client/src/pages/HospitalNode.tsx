    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — ATOMIC TYPESCRIPT TEST COMMIT</span><h2>A future TypeScript test suite may exist only inside one fresh private sequence with a final scalar receipt.</h2></div><p>The design binds fresh candidate, current source/test controls, new readiness, image-local manager, empty future resources, containment, and one exact receipt. It then either invokes the declared TypeScript test suite immediately or expires and removes all private state. This is design evidence only—not candidate consumption, target action, test execution, source transfer, container activity, runtime, Core, identity, data/model, Python tests, trainer, submission, aggregation, release, deployment, hospital, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
