    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DATA-USE GATE — PUBLIC METADATA REVIEW RETAINS INELIGIBILITY</span><h2>Supplied data pages were reviewed without opening any dataset asset.</h2></div><p>The public-page review identified displayed descriptions and license/access conditions only. No candidate passed the separate data-use gate: rights, source-chain, and governance conditions remain unresolved. No dataset asset was downloaded, opened, copied, or processed; no privacy, clinical, model, performance, deployment, or runtime claim is made.</p><CheckCircle2 size={24} /></section>
        </div>
