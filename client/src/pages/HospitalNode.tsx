    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — PROVENANCE EXCEPTION NOT AUTHORIZED</span><h2>Compensating controls are specified, but integrity alone cannot admit the seed to the target.</h2></div><p>The control review requires a distinct risk owner, immutable seed identity, bounded expiry/revocation, isolated private workspace, non-public/no-Agent posture, aggregation disabled, independent release identity, protected composition, fresh Core control, scalar receipt, and cleanup. The current state is <code>provenance_exception_not_authorized</code>: provenance is unavailable, no exception is active, and target transfer/install/source build/container/Agent/Core/runtime/proof/data/model/trainer/submission/aggregation actions remain blocked.</p><CheckCircle2 size={24} /></section>
        </div>
