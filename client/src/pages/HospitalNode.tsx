    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SOURCE-ONLY SYNTHETIC STUDY-INTENT VALIDATOR QUALITY-GATED</span><h2>A proposed study can be classified without creating a study or empirical result.</h2></div><p>Agent release <strong>5e923fe</strong> adds a scalar validator that accepts only the exact proposed-study and non-execution postures before projecting one allowlisted result. Local CI and Hospital Node Quality Gates passed with deterministic source-only fixtures. This is source-quality evidence only—not a study, test, training, data/model access, metric, update, submission, aggregation, target full-CI certification, release, deployment, runtime, hospital, clinical, privacy, or scientific result. No target action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
