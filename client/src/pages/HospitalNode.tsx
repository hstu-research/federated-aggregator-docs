    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — FRESH CANDIDATE CONSUMPTION</span><h2>Execution readiness must be renewed for a new opaque candidate, then expire if not immediately used.</h2></div><p>The design prohibits reuse of prior readiness. A future candidate must bind current scalar controls, new readiness, empty resources, and not-started posture; it then either expires or privately precedes one separately recorded stage invocation. This is design evidence only—not candidate consumption, target revalidation, formatter execution, source transfer, container activity, runtime, Core, identity use, data/model access, trainer, submission, aggregation, release, deployment, hospital, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
