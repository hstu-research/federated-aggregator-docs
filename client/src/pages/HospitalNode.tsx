...
const documents = [
  ...
  { title: "Professional generic source-only thesis manuscript (Word)", description: "University-style Word companion with formal preliminary-page placeholders and the complete integrated manuscript; it adds no research evidence.", file: "SYNTHETIC_FEDPROX_THESIS_PROFESSIONAL_EDITABLE_MANUSCRIPT.docx", href: "/manus-storage/SYNTHETIC_FEDPROX_THESIS_PROFESSIONAL_EDITABLE_MANUSCRIPT_d587478e.docx" },
  { title: "Final source-only thesis review package", description: "Compact archive of the professional editable manuscript and claim-control materials for supervisor, examiner, or copy-edit review.", file: "SYNTHETIC_FEDPROX_THESIS_FINAL_REVIEW_PACKAGE.zip", href: "/manus-storage/SYNTHETIC_FEDPROX_THESIS_FINAL_REVIEW_PACKAGE_b90b6cf9.zip" },
    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — PROFESSIONAL GENERIC FORMAT RETAINS THE BOUNDED CONTRIBUTION</span><h2>The thesis is now professionally formatted without evidence expansion.</h2></div><p>The professional generic Word manuscript adds formal preliminary-page placeholders, conventional academic typography, chapter hierarchy, tables, and references. Candidate and institution details remain intentionally unfilled, while the source-only research question, method, local findings, explicit non-results, and independently governed future-work path are retained. No data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
