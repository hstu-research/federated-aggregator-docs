    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — ONE-USE TARGET FORMAT DIAGNOSTIC</span><h2>The future target format check is bounded by an explicit cleanup and terminal-closure contract.</h2></div><p>The design binds quality-gated source, composition context, image-local manager, source-only admission, hardened controls, an unused identity, and scalar cleanup. It may later emit only a clean-stage or allowlisted closure class, then removes private receipts, transients, named container, and disposable image. This is design evidence only—not target access, formatting execution, source repair, release, deployment, runtime, hospital, Core, identity, data/model, trainer, submission, aggregation, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
