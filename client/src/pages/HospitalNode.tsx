    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — ONE-USE INVOCATION DECISION</span><h2>An admitted identity is never an implicit execution right.</h2></div><p>The design allows only one valid, admitted-unconsumed, unused, exact-scope decision. Any expiry, cancellation, predicate drift, or replay removes private state before source, package, image, container, workspace, target, or formatter activity. This is design evidence only—not target access, formatting execution, runtime, Core, identity use, data/model access, trainer, submission, aggregation, release, deployment, hospital, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
