    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SYNTHETIC FEDPROX STUDY-INTENT QUESTION SELECTED</span><h2>A proposed study should be distinguishable from an executed empirical result before training begins.</h2></div><p>The next independent question asks whether a descriptor-only synthetic FedProx study-intent declaration can make that separation explicit before any trainer, data, model, metric, update, or aggregation action. It is separate from the closed source-quality chain. This is a research-question selection only—not a study protocol, test, data/model access, training, metric, update, submission, aggregation, runtime, hospital, clinical, privacy, or scientific result.</p><CheckCircle2 size={24} /></section>
        </div>
