    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — ISOLATED TARGET TYPE CHECK</span><h2>The next target quality boundary is a separate one-shot type-check with its own candidate and cleanup.</h2></div><p>The design permits only the declared type-check stage inside a fresh disposable image-local manager context, under unprivileged, read-only, no-network, capability-dropped, resource-bounded controls. It has scalar-only outcomes and cannot reuse the closed formatting candidate or run any other quality/runtime stage. This is design evidence only—not target action, type-check execution, source transfer, container activity, runtime, Core, identity, data/model, trainer, submission, aggregation, release, deployment, hospital, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
