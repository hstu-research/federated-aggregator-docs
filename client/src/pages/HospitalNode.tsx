    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — FRESH READ-ONLY REVALIDATION PLAN</span><h2>The next target session is limited to four posture classes and an expiring scalar receipt.</h2></div><p>The design permits one read-only recheck only after a fresh private identity and authorized-unstarted decision. It may classify container-engine, candidate-resource, workspace, and diagnostic-not-started posture, then expire or close without starting the format diagnostic. This is design evidence only—not target revalidation, formatter execution, source transfer, container activity, runtime, Core, identity use, data/model access, trainer, submission, aggregation, release, deployment, hospital, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
