    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>SOURCE-ONLY CONTROL — IN-MEMORY TERMINAL LEDGER PRESERVES CLOSURE</span><h2>A synthetic rejection state remains closed across a fake-ledger reconstruction.</h2></div><p>The isolated deterministic Agent fixture retains only frozen scalar terminal closure, rejects invalid receipts and snapshots, and suppresses replay. Its aggregate local quality suite passed. It uses no database, filesystem, cache, provider, or external persistence; it receives no payload, does not process patient data, and is not privacy, clinical, hospital, deployment, or runtime proof.</p><CheckCircle2 size={24} /></section>
        </div>
