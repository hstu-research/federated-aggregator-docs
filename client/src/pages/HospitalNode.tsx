    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>SOURCE-ONLY CONTROL — SYNTHETIC MARKER REJECTION CLOSES BEFORE TRANSFER</span><h2>A generated marker can be rejected without receiving real patient data.</h2></div><p>The isolated Agent validator accepts only an exact frozen generated scalar marker, returns a blocked, evaluation-not-started, execution-not-performed receipt, rejects invalid declarations, and suppresses replay. Its aggregate local quality suite passed. It does not ingest, upload, inspect, classify, store, or process patient data and is not privacy, clinical, hospital, deployment, or runtime proof.</p><CheckCircle2 size={24} /></section>
        </div>
