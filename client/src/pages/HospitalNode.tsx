    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — LIVE REMOTE OBSERVATION REMAINS INELIGIBLE BY DEFAULT</span><h2>Local classification is not permission to inspect a workflow.</h2></div><p>The source-only classifier is locally validated, but a future live read-only observation still requires separately assigned authority, one bounded scope, a fixed redacted scalar taxonomy, and a non-mutating posture. Until then, it is unassigned and closed by default. No remote client, workflow query, dispatch, retry, cancellation, configuration change, target access, study, runtime, or clinical activity is authorized or evidenced.</p><CheckCircle2 size={24} /></section>
        </div>
