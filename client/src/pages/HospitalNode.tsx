    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — UPDATE-SUBMISSION ADMISSION QUALITY GATED</span><h2>Symbolic update submission now closes safely—without a request, identity resolution, Core call, connection, or submission.</h2></div><p>Agent revision <code>44bd982</code> adds the one-use pure pre-transport validator. It accepts an exact frozen envelope, privately canonicalizes update-envelope, route, identity, idempotency, and retained-control classes, emits frozen scalar admission/closure/readout, and suppresses replay. The full local chain passed 233 TypeScript plus 4 Python tests; remote Quality Gates run <code>32802753224</code> succeeded. This is source quality only: no update/request/transport, identity resolution, Core contact, trainer or Agent action, submission, or aggregation occurred.</p><CheckCircle2 size={24} /></section>
        </div>
