    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — EXACT PACKAGE ACQUISITION CLOSED</span><h2>The one-use pnpm acquisition closed before verification, and no local seed remains.</h2></div><p>The single local attempt for <code>pnpm@10.16.1</code> did not reach exact-version or integrity admission. Its transient custody closed, the sealed-seed check is absent, and the result is <code>pnpm_acquisition_closed</code>. No failure internals were projected and no retry occurred. The target, source build, container/Agent, Core/runtime, proof, data/model/trainer, submission, and aggregation boundaries remained untouched.</p><CheckCircle2 size={24} /></section>
        </div>
