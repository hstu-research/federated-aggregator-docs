    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>FRESH BUILD GATE</span><h2>A fresh BuildKit OCI provenance candidate is quality-gated; exactly one new private synthetic build is the next isolated action.</h2></div><p>The first candidate remains terminally closed after unavailable GitHub attestation storage. The fresh workflow revision removes that unavailable action and requests fixed BuildKit OCI provenance directly, with narrower permissions and unchanged manual-only, immutable SHA, private package, cancellation-free, redacted boundaries. The fresh candidate has not run. Exactly one new private synthetic build is permitted; Azure staging, target binding, Compose render, projection, proof, training, submission, and aggregation remain separately blocked behind later evidence.</p><CheckCircle2 size={24} /></section>
        </div>
