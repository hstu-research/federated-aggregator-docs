    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — FEDPROX EVIDENCE DESIGN</span><h2>The scientific path now has a bounded synthetic FedProx contract—without conflating arithmetic checks with model evidence.</h2></div><p>The design binds synthetic-only fixture provenance, opaque deterministic seed class, exact local-epoch and proximal-term contract, scalar-only metric provenance, finite validation/closure, and strict scientific non-claims. Existing Python checks establish toy FedProx arithmetic and shape rejection only; they do not train a model, process a dataset, report accuracy, or represent a hospital workload. No data access, training, Agent/runtime action, submission, or aggregation occurred.</p><CheckCircle2 size={24} /></section>
        </div>
