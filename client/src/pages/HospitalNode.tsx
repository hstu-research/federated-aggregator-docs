    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>STATIC RENDER-INTENT SOURCE QUALITY</span><h2>Disabled target posture is quality-gated as a scalar policy; no configuration was created.</h2></div><p>Release <code>ad2e2ed</code> implements the source-only static render-intent validator, terminal decision policy, private deterministic sink, frozen readouts, and import guard. One eligible request records only <code>disabled_not_rendered</code>; malformed, fallback, non-fresh, unprepared, unreserved, activation/exposure/restart/network, sink-failure, and replay cases close terminally. Local CI and Hospital Node Quality Gates passed. No configuration artifact, renderer, process, filesystem, environment, root/image binding, package/credential/target, staging, proof, training, submission, or aggregation action occurred. A concrete renderer review remains a separate design boundary.</p><CheckCircle2 size={24} /></section>
        </div>
