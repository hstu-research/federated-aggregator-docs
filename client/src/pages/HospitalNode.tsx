    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — INTEGRATED MANUSCRIPT RETAINS THE BOUNDED CONTRIBUTION</span><h2>The full draft now states what the thesis establishes—and what it does not.</h2></div><p>The new six-chapter manuscript assembles the source-only research question, method, local findings, explicit non-results, and independently governed future-work path. Published work is context only; empirical, privacy, clinical, hospital, operational, deployment, and runtime evidence remains absent. No data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
