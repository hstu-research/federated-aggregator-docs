    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — ONE-USE TOOLCHAIN PROVISION DESIGNED</span><h2>The missing toolchain has a private provision contract, but none of its admission packets is current.</h2></div><p>The design separates risk owner, provision operator, and target runtime; binds one sealed exact seed; requires a rechecked private target scope, no global/system/profile/network path, no runtime, scalar receipt, cleanup, expiry, and terminal closure. Provenance exception, source/release, protected composition, and fresh Core-control packets remain incomplete, so no transfer/install/source build/Agent/container/Core/runtime/proof/data/model/trainer/submission/aggregation action is authorized or occurred.</p><CheckCircle2 size={24} /></section>
        </div>
