...
const documents = [
  ...
  { title: "Editable source-only thesis manuscript (Word)", description: "Formatted Word companion with editorial placeholders and the complete integrated manuscript; it adds no research evidence.", file: "SYNTHETIC_FEDPROX_THESIS_INTEGRATED_MANUSCRIPT_EDITABLE.docx", href: "/manus-storage/SYNTHETIC_FEDPROX_THESIS_INTEGRATED_MANUSCRIPT_EDITABLE_4350114a.docx" },
  { title: "Final source-only thesis review package", description: "Compact archive of the editable manuscript and claim-control materials for supervisor, examiner, or copy-edit review.", file: "SYNTHETIC_FEDPROX_THESIS_FINAL_REVIEW_PACKAGE.zip", href: "/manus-storage/SYNTHETIC_FEDPROX_THESIS_FINAL_REVIEW_PACKAGE_36e58bd9.zip" },
    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — FINAL PACKAGE-READINESS RECORD RETAINS THE BOUNDED CONTRIBUTION</span><h2>The review materials are reconciled for editorial use without evidence expansion.</h2></div><p>The final package-readiness record reconciles the editable manuscript, reviewer guide, claim-control materials, refreshed archive, and delivery link. It confirms internal editorial-package alignment only, retains explicit non-results, and preserves independently governed future-work language. No data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
