    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>TEMPORARY-ROOT PORT FACTORY SOURCE QUALITY</span><h2>Single-use scalar durability is quality-gated while root and correlation stay private.</h2></div><p>Release <code>059c9c8</code> implements the local temporary-root port factory, private parallel-store/root/correlation closure, frozen readout, one-use lifecycle, fixtures, and import guard. The port offers only hydrate, claim, terminal, dispose, and snapshot. Terminal/orphan hydration, claim or terminal denial, and disposal close; later calls are replay-suppressed. Canonical lifecycle, temporary-residue denial, independent ports, disposal, and redaction passed local and Hospital Node Quality Gates. No target root, application wiring, coordinator, parser, renderer, configuration text/file, target action, package/credential access, staging, proof, training, submission, or aggregation action occurred. Coordinator compatibility remains separately gated.</p><CheckCircle2 size={24} /></section>
        </div>
