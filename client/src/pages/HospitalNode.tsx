    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — ONE TARGET FORMAT STAGE CLEAN</span><h2>The declared formatting stage ran once under hardened controls and its cleanup is confirmed.</h2></div><p>One compound diagnostic emitted <code>format_stage_clean</code>, followed by <code>format_stage_cleanup_confirmed</code>. It used a disposable image-local manager context with unprivileged, read-only, no-network, capability-dropped, resource-bounded controls; private inputs and transients were removed. This is one stage-only result—not full CI, broad source quality, release, provisioning, deployment, runtime, hospital, Core, identity, data/model, trainer, submission, aggregation, or scientific evidence.</p><CheckCircle2 size={24} /></section>
        </div>
