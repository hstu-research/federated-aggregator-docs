    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — EXTERNAL EVIDENCE REQUIRED</span><h2>No internal code increment remains: protected-runtime evidence, not another symbolic control, is now the direct gate.</h2></div><p>The readiness review, one-shot proof lifecycle, and FedProx evidence boundary are already documented; the proposed execution gate also closed as <code>execution_binding_unavailable</code>. Only source-quality evidence is recorded. A separately authorized package/identity record, target-bound release, protected composition/configuration evidence, and fresh authoritative Core-control preflight must all exist before a proof decision. No credential retry, package or target access, Agent start, Core contact, proof, training, submission, or aggregation action occurred.</p><CheckCircle2 size={24} /></section>
        </div>
