    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — SOURCE-QUALITY EVIDENCE SEPARATION DESIGNED</span><h2>Stage-level evidence may be preserved without turning it into a whole-CI pass.</h2></div><p>The next design permits only a scalar-safe synthesis of already published formatting, type-check, TypeScript-test, Python-test, and cleanup classes. It preserves the terminal Python closure and can project only partial evidence or closure—not a score, pass, diagnostic cause, retry, release, deployment, runtime, hospital, Core, identity, data/model, training, submission, aggregation, or scientific claim. This is design evidence only; no source or target activity occurred.</p><CheckCircle2 size={24} /></section>
        </div>
