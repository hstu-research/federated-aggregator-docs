    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>PARALLEL LOCAL ADAPTER SOURCE QUALITY</span><h2>Atomic claim-terminal closure is quality-gated against temporary roots, never a target root.</h2></div><p>Release <code>ce171d8</code> implements the parallel local claim-terminal adapter, temporary-root fixture capability, canonical scalar records, atomic promotion lifecycle, aggregate readout, and filesystem isolation. It remains separate from the authorization-diagnostic store. Empty-to-terminal closure, duplicate/mismatch rejection, malformed/noncanonical and temporary-residue closure, symlink/mode root denial, and redaction passed local and Hospital Node Quality Gates. No target root, application composition, coordinator, parser, renderer, configuration text/file, target action, package/credential access, staging, proof, training, submission, or aggregation action occurred. Adapter-port integration remains separately gated.</p><CheckCircle2 size={24} /></section>
        </div>
