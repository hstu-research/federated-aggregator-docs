    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — IMAGE-LOCAL PACKAGE-MANAGER ACCESSIBLE</span><h2>The hardened collector user can access the exact package-manager surface inside the disposable image.</h2></div><p>A fresh exact-source workspace and disposable remediation image emitted <code>package_manager_accessible</code> under unprivileged, read-only, no-network controls. The package-manager surface is image-local only: no target-host toolchain, prior seed, source, runtime, listener, Core, data/model, trainer, submission, aggregation, release, deployment, hospital, or scientific state changed. No version, executable/cache/location, package/provider/registry, target configuration, credential, source, data/model, or transcript was retained.</p><CheckCircle2 size={24} /></section>
        </div>
