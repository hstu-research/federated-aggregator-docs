    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>SOURCE-ONLY CONTROL — FIXED COMPOSITION PROJECTS ONE TERMINAL BLOCKED RESULT</span><h2>The complete local chain stays closed without receiving any data.</h2></div><p>The deterministic Agent composition constructs one generated scalar marker internally and joins the validator, one-use consumer, in-memory ledger, and disabled fake into one fresh blocked, evaluation-not-started, execution-not-performed readout. Its aggregate local quality suite passed. It accepts no caller input, receives no payload, does not process patient data, and is not an end-to-end data, privacy, clinical, hospital, deployment, or runtime proof.</p><CheckCircle2 size={24} /></section>
        </div>
