    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>DIRECT THESIS PATH — CONCLUSION CLOSES AT THE EVIDENCE BOUNDARY</span><h2>The contribution is accountable distinction, not a claimed performance gain.</h2></div><p>The new conclusion consolidates frozen study intent, terminal closure, default-closed readiness, and evidence discipline while explicitly stating no data/model, evaluation, privacy, clinical, hospital, operational, deployment, or runtime result. Any future empirical work remains independently governed. No data/model, adapter, training, metric, aggregation, remote, runtime, hospital, clinical, privacy, or performance evidence exists.</p><CheckCircle2 size={24} /></section>
        </div>
