...
- [ ] Increment L4e3x5b — Design and implement additive source-only scalar persistence/restart semantics for the terminal authorization diagnostic. Preserve terminal no-retry/replay suppression, reject forbidden/free-text/path/provider-shaped persistence, and keep all provider, credential, package, target, proof, and aggregation capabilities out of scope.
