...
- [ ] Increment L4e2x3 — Design source-only protected-builder admission orchestration using scalar role separation, terminal authorization/denial/quarantine states, aggregate-safe redacted readout, and deterministic fakes. Do not mint credentials or call a builder/registry; do not build/push an image, stage Azure, render Compose, open a projection, or invoke proof.
