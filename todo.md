...
- [ ] Increment L4e2b — Implement only the documented coordination components and deterministic local contract tests after L4e2a is public. No target-runtime invocation, live secret, Core/Azure request, provider access, training, update, submission, or aggregation.
