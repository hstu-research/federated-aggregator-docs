...
- [ ] Increment L4e2p — Implement an injected fake protected-projection metadata/read/closure port and opaque in-memory lease, with no Node filesystem import. Test kind/mode/owner/size/change/read/disposal/restart denials, scalar error collapse, redaction, no cache/watch/retry, and explicit closure before considering a separate concrete read-edge implementation.
