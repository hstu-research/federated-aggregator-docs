...
- [ ] Fresh image gate L4e3x3 — After source quality, dispatch exactly one fresh immutable synthetic candidate using the compatible provenance mechanism. Verify only redacted scalar status and retain target-unbound state.
