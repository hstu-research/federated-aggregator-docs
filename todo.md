...
- [ ] Live provenance gate L4e3x2 — Publish the redacted terminal attestation-failure record and revise the workflow for a private-plan-compatible OCI provenance mechanism. Do not retry the closed candidate or expose a package/image locator.
